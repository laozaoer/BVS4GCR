...
# Internal function to simulate from the HIWishart distribution given a decoposable graph. The R code of this function is a modified 
# version of the Matlab code of Carvalho et al. (2007) and Talhouk et al. (2012). For details, see Alexopoulos and Bottolo (2019)
